(function (global, factory) {
    ...
    class Shuffle extends tinyEmitterExports {
         ...
         * @param {Object} [options=Func_shuffle.options] Options object.
         * @constructor
         */
        constructor(element) {
            ...
            if (!el) {
                throw new TypeError('Func_shuffle needs to be initialized with an element.');
            }
            this.element = el;
            this.id = `shuffle_${id}`;
            id += 1;
        ...
        _init() {
            ...
            // event and call `update()` if ResizeObserver is missing, or use Func_shuffle v5.
         ...
         * initialization of a new Func_shuffle instance.
         * @param {ShuffleItem[]} items Func_shuffle items to set transitions on.
         * @protected
         */
        ...
        _handleResizeCallback(entries) {
            ...
            // code using Babel, but Func_shuffle no longer supports browsers that old, so
         ...
         * which work perfectly for all Func_shuffle's use cases.
         *
         * 1. getBoundingClientRect() `left` and `right` properties.
         *   - Accounts for transform scaled elements, making it useless for Func_shuffle
    ...
    Shuffle.options = {
        ...
        // Func_shuffle can be initialized with a sort object. It is the same object
...
//# sourceMappingURL=func_shuffle.js.map